package com.gamefree.dailyhoroscopes.network;
...
import com.gamefree.dailyhoroscopes.common.Constants;
...
public class NetworkOperator {
	...
	public void getFanpageCodeInfo(
			Response.Listener<JSONObject> responseSuccessListener,
			Response.ErrorListener responseErrorListener) {

		MyGetRequest request = new MyGetRequest(context,
				Constants.FANPAGE_URL_2, null, responseSuccessListener,
	...
	public void getNewFeed(int limit,
		...
		String params = "select object_id,caption,src_big,like_info,comment_info,created FROM photo WHERE owner = '340505782696997'  LIMIT "
				+ limit;
